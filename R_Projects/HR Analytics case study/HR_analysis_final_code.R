...
emp_survey <- read.csv("datasets/employee_survey_data.csv",stringsAsFactors = FALSE)
man_survey <- read.csv("datasets/manager_survey_data.csv",stringsAsFactors = FALSE)
in_time <- read.csv("datasets/in_time.csv",stringsAsFactors = FALSE)
out_time <- read.csv("datasets/out_time.csv",stringsAsFactors = FALSE)
general_data <- read.csv("datasets/general_data.csv",stringsAsFactors = FALSE)
